...
public class MainActivityTest
{
    ...
    @Test
    public void testShouldFillAdapterWithReposFromApi() throws Exception
    {
    ...
    @Test
    public void testShouldToastSadMessageIfNoRepos() throws Exception
    {
        Mockito.verify(mockApi).repositories(Mockito.anyString(), cb.capture());
    ...
    @Test
    public void testShouldToastIfApiError() throws Exception
    {
        Mockito.verify(mockApi).repositories(Mockito.anyString(), cb.capture());
